const channels = [
  ...
  { name: "Facebook", handle: "/piraquaraonline", desc: "Notícias, debates e a comunidade reunida." },
  { name: "YouTube", handle: "/piraquaraonline", desc: "Reportagens em vídeo e entrevistas locais." },
      ...
      <div className="container-editorial">
        <div className="grid lg:grid-cols-12 gap-10 mb-12">
          <div className="lg:col-span-7">
            <p className="eyebrow">05 — Redes</p>
          ...
          <p className="lg:col-span-4 lg:col-start-9 self-end text-muted-foreground">
            Acompanhe a cobertura em tempo real, vídeos diários e os bastidores das pautas que
            estão movimentando Piraquara.
          </p>
        </div>
          ...
          {channels.map((c) => (
            ...
            >
              ...
              <div className="mt-6 flex items-end justify-between">
                ...
                <span className="text-petrol group-hover:translate-x-1 transition-transform">↗</span>
              </div>
            </a>
          ))}
        </div>
